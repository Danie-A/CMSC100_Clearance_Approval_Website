        ...
        <div className="d-flex flex-column gap  -1 p-0 py-sm-3 px-sm-4 w-100 h-100 justify-content-between">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <input
              ...
              onChange={(e) => setEditApproverInfo({ ...editApproverInfo, first_name: e.target.value })}
            />
          </div>
          <div className="d-flex align-items-center gap-3">
            ...
            <input
              ...
              onChange={(e) => setEditApproverInfo({ ...editApproverInfo, middle_name: e.target.value })}
            />
          </div>
          <div className="d-flex align-items-center gap-3">
            ...
            <input
              ...
              onChange={(e) => setEditApproverInfo({ ...editApproverInfo, last_name: e.target.value })}
            />
          </div>
          <div className="d-flex align-items-center gap-3">
            <label>Email: </label>
            <input className="glass-effect-5 flex-grow-1 px-3" placeholder="email" value={editApproverInfo.email} onChange={(e) => setEditApproverInfo({ ...editApproverInfo, email: e.target.value })} />
          </div>
          <br />
