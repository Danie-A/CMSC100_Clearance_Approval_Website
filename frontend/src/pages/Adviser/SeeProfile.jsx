...
export default function SeeProfile({ handleCloseModal, student }) {
    ...
    return (<>
        ...
        <div className="whole-container">
            ...
            <div><strong>Date Submitted:</strong>  {formattedDateTime}</div>
            {showLink()}
            <br />
            <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                <button onClick={handleOpenRemark}><BiCommentDetail className="mr-2" style={{ marginRight: '8px' }} />View Adviser Remarks</button>
